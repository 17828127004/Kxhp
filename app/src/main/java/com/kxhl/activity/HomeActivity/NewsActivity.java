...
public class NewsActivity extends Activity{
    ...
    public void getWebView() {
        ...
        String url=getIntent().getExtras().getString("new");
//        String urls=getIntent().getExtras().getString("newTwo");
        wv_store.loadUrl(url);
        new TitleUtil(this).setTitleName("新闻详情").setLeftImage(R.drawable.happy_mine_back)
