 ...
 */
public class LineTimeActivity extends FragmentActivity {
    ...
    public Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            msg.what = 0;
            pushService((String) SaveData.get(LineTimeActivity.this, Config.USERID, ""), mCity, mLat, mLng);
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutView= LayoutInflater.from(this).inflate(R.layout.fragment_timeting,null);
        setContentView(layoutView);
        new TitleUtil(layoutView).setTitleName("预约").setLeftImage(R.drawable.happy_mine_back).
        ...
        public void onPageSelected(int position) {
            switch (position) {
                case 0:
                    ...
                    tv_month1.setTextColor(resources.getColor(R.color.white));
                    tv_day1.setTextColor(resources.getColor(R.color.white));
                    tv_month2.setTextColor(resources.getColor(R.color.time_txt));
                    tv_day2.setTextColor(resources.getColor(R.color.time_txt));
                    tv_month3.setTextColor(resources.getColor(R.color.time_txt));
                    tv_day3.setTextColor(resources.getColor(R.color.time_txt));
                    tv_month4.setTextColor(resources.getColor(R.color.time_txt));
                    tv_day4.setTextColor(resources.getColor(R.color.time_txt));
                    tv_month5.setTextColor(resources.getColor(R.color.time_txt));
                ...
                case 1:
                    ...
                    tv_month1.setTextColor(resources.getColor(R.color.time_txt));
                    tv_day1.setTextColor(resources.getColor(R.color.time_txt));
                    tv_month2.setTextColor(resources.getColor(R.color.white));
                ...
                case 2:
                    ...
                    tv_month2.setTextColor(resources.getColor(R.color.time_txt));
                    tv_day2.setTextColor(resources.getColor(R.color.time_txt));
                    tv_month3.setTextColor(resources.getColor(R.color.white));
                ...
                case 3:
                    ...
                    tv_month3.setTextColor(resources.getColor(R.color.time_txt));
                    tv_day3.setTextColor(resources.getColor(R.color.time_txt));
                    tv_month4.setTextColor(resources.getColor(R.color.white));
                ...
                case 4:
                    ...
                    tv_month4.setTextColor(resources.getColor(R.color.time_txt));
                    tv_day4.setTextColor(resources.getColor(R.color.time_txt));
                    tv_month5.setTextColor(resources.getColor(R.color.white));
...
//        TimeFiveFragment timeFiveFragment = TimeFiveFragment.newInstance (mNames,mPaths,mTimes,mStoreId,mDistance,mStart);
        ...
        mVp.setAdapter(new MyFragmentPagerAdapter(getSupportFragmentManager(), fragments));
